...
@section('content')
    <div x-data="{ fullscreenModal: false, imageUrl: '' }" x-init="$watch('fullscreenModal', function(value) {
        if (value === true) {
            showModal()
        ...
        <div class="max-w-md mx-auto mb-4" x-data>

            <div class="relative navbar ">
                <div class="flex-none gap-2">
                    <div class="form-control">
                        <input id="default-search" type="text" placeholder="Search"
                            @keydown.enter="$store.dataStore.fetchSearch();" class="input input-bordered w-24 md:w-auto" />

                    </div>
                    <button :disabled="$store.dataStore.isLoading" class="btn btn-ghost btn-circle btn-outline"
                        @click="$store.dataStore.fetchSearch();">
        ...
        <div x-data="{
            ...
            <div x-data x-init="$store.dataStore.fetchData();
            $store.dataStore.fetchCollections();
            $store.dataStore.fetchTags()"
                                    ...
                                    <div class="card bg-base-100 w-96 shadow-xl">
                                        ...
                                        <div class="card-body">
                                            <h2 class="card-title truncate w-full pr-9 text-primary text-sm"
                                                x-text="link.name"></h2>
                                            <div @click="window.open(link.url, '_blank')" class="text-xs truncate link"
                                                x-text="link.url">
                                            </div>
                                            ...
                                            <div class="justify-start">
                                                <a :href="`/storage/${link.image}`" data-pswp-width="1669"
                                                    data-pswp-height="2500" target="_blank"
                                                    class="btn btn-outline btn-square">
                                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
                                                        fill="none" stroke="currentColor" stroke-width="2"
                                                        stroke-linecap="round" stroke-linejoin="round"
                                                        class="lucide lucide-fullscreen h-6 w-6">
        ...
        <template x-teleport="body">
            <div x-show="fullscreenModal" x-transition:enter="transition ease-out duration-300"
                ...
                <div class="flex items-center justify-center w-full h-full">
                    <img :src="`/storage/${imageUrl}`" alt="Preview Image"
                        ...
                        <div class="relative w-auto pb-8">
                            <div class="p-6 pt-0 space-y-2">
                                ...
                                <div class="space-y-1">
                                    ...
                                    <textarea type="text" placeholder="Type your message here." id="descriptionLink" name="description"
                                ...
                                <div class="space-y-1">
                                    ...
                                    <select name="collection" id="collectionLink"
                                        ...
                                        <template x-for="collection in $store.dataStore.collections"
                                            :key="collection.id">
                        ...
                        <div class="relative w-auto pb-8">
                            <div class="p-6 pt-0 space-y-2">
                                ...
                                <div class="space-y-1">
                                    ...
                                    <textarea type="text" placeholder="Type your message here." id="descriptionCollections" name="description"
                                        class="flex w-full h-auto min-h-[80px] px-3 py-2 text-sm bg-base-100 border rounded-md border-neutral-300 placeholder:text-neutral-400 focus:border-neutral-300 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-neutral-400 disabled:cursor-not-allowed disabled:opacity-50"></textarea>
        ...
        document.addEventListener('alpine:init', () => {
            Alpine.store('dataStore', {
                ...
                fetchSearch() {
                    ...
                    this.isLoading = true;
                    const token = window.PTNToken; // Thay thế bằng token của bạn
                    axios.post('https://wave.test/links/search', {
                            search: keyword // payload data
                        }, {
                            headers: {
                        ...
                        .catch(error => console.error('Error fetching links:', error)).finally(() => {
                            this.isLoading = false; // Đặt lại isLoading sau khi tìm kiếm xong
                        });
                },
                nextPage() {
