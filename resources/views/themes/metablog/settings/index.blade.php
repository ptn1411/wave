...
<div class="flex px-8 mx-auto my-6 mt-44 max-w-7xl xl:px-5">

    <!-- Left Settings Menu -->
    <div class="w-16 mr-6 md:w-1/5">

        <div
            class="relative flex flex-col items-start justify-center w-full py-6 bg-base-200 border rounded-lg border-gray-150">
            <h3 class="hidden px-6 pb-3 text-xs font-semibold leading-4 tracking-wider uppercase md:block">
                Settings</h3>
            ...
            <a href="{{ route('wave.settings', 'profile') }}"
                ...
                <svg class="flex-shrink-0 w-5 h-5 mr-3 -ml-1  transition duration-150 ease-in-out group-hover:text-gray-500 group-focus:text-gray-500"
        ...
        <div
            class="relative flex flex-col items-start justify-center w-full py-6 mt-6 bg-base-200 border rounded-lg border-gray-150">
            <h3
    ...
    <div class="flex flex-col w-full bg-base-200 border rounded-lg md:w-4/5 border-gray-150">
        <div class="flex flex-wrap items-center justify-between border-b sm:flex-no-wrap">
            <div class="relative p-6">
                <h3 class="flex text-lg font-medium leading-6 text-gray-600">
                    ...
                    @if(isset($section_title)){{ $section_title }}@else{{ Auth::user()->name . '\'s' }}
                    {{ ucwords(str_replace('-', ' ', Request::segment(2)) ?? 'profile') . ' Settings' }}@endif
                </h3>
            </div>
        </div>
