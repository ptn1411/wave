...
<div class="max-w-4xl px-5 mx-auto mt-44 lg:px-0">
    <a href="{{ route('wave.announcements') }}"
...
<article id="announcement-{{ $announcement->id }}"
    class="max-w-4xl px-5 pb-20 mx-auto prose prose-xl lg:prose-2xl lg:px-0">
    ...
    <div class="max-w-4xl mx-auto mt-6">
        <h1 class="flex flex-col leading-none">
            ...
            <span class="mt-10 text-base font-normal">Written on <time
                    datetime="{{ Carbon\Carbon::parse($announcement->created_at)->toIso8601String() }}">{{ Carbon\Carbon::parse($announcement->created_at)->toFormattedDateString() }}</time>.
            </span>
        </h1>
    </div>
