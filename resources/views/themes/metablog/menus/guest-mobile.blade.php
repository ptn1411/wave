<nav>
    <div div class="block xl:hidden">
        <div :class="sidebarOpen ? 'left-0' : '-left-full'" class="overflow-y-auto z-40 flex pt-5 top-0 flex-col h-screen w-full max-w-[300px] fixed bg-base-200
       duration-500 ease-in gap-2 md:gap-0 shadow-xl">
            <div class="relative flex flex-col gap-5 px-5 pb-6 mt-4 text-lg font-normal leading-6">
                <div class="flex items-center justify-between mb-6">
                    ...
                    <svg @click="sidebarOpen = false" class="cursor-pointer" width="10" height="10" view-box="0 0 10 10"
