<nav>
    <div div class="block xl:hidden">
        <div :class="sidebarOpen ? 'left-0' : '-left-full'"
            class="overflow-y-auto z-40 flex pt-5 top-0 flex-col h-screen w-full max-w-[300px] fixed bg-base-200
       duration-500 ease-in gap-2 md:gap-0 shadow-xl">
            <div class="relative flex flex-col gap-5 px-5 pb-6 mt-4 text-lg font-normal leading-6">
                <div class="flex items-center justify-between mb-6">
                    <h4 class="text-base text-base-content/80">Menu</h4>
                    <svg @click="sidebarOpen = false" class="cursor-pointer" width="10" height="10"
                        view-box="0 0 10 10" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M1 9L9 1M1 1L9 9" stroke="#6B7280" stroke-width="1.5" stroke-linecap="round"
    ...
    <div @click="sidebarOpen = false" :class="sidebarOpen ? 'left-0' : '-left-full'"
        class="xl:hidden fixed top-0 z-30 transition-all duration-500 ease-in-out bg-[#1B2631] opacity-80 h-full w-full" />
</nav>
