        ...
        <div class="container mx-auto">
            <div class="grid grid-cols-12 gap-5 py-16">
                <div class="col-span-12 lg:col-span-3">
                    ...
                    <p class="mt-3 text-base text-base-content/70 mb-6 font-sans">Lorem ipsum dolor sit amet, consectetur
                        adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad
                        minim veniam</p>
                    <div>
                        <a href="mailto:test@example.com" class="font-semibold text-base-content text-base font-sans">
                            Email : <span
                                class="text-base-content/70 font-normal hover:text-primary hover:duration-300 transition font-sans">test@example.com</span>
                        </a>
                    </div>
                    <div class="mt-1">
                        <a href="tel:880123456789" class="font-semibold text-base-content text-base font-sans">
                            Phone : <span
                                class="text-base-content/70 font-normal hover:text-primary hover:duration-300 transition font-sans">880
                                123 456 789</span>
                        </a>
                    </div>
                </div>
                <div class="flex justify-between lg:justify-center lg:gap-20 col-span-12 lg:col-span-5">
                    <div>
                        ...
                        <div class="flex flex-col gap-y-2 mt-6">
                            <a href="../"
                                class="link link-hover text-base text-base-content/70 hover:text-primary transition hover:duration-300 font-sans">Home</a>
                            <a href="#"
                                class="link link-hover text-base text-base-content/70 hover:text-primary transition hover:duration-300 font-sans">About</a>
                            <a href="../blog/index.html"
                                class="link link-hover text-base text-base-content/70 hover:text-primary transition hover:duration-300 font-sans">Blog</a>
                            <a href="../"
                                class="link link-hover text-base text-base-content/70 hover:text-primary transition hover:duration-300 font-sans">Archived</a>
                            <a href="../author/html"
                                class="link link-hover text-base text-base-content/70 hover:text-primary transition hover:duration-300 font-sans">Author</a>
                            <a href="#"
                                class="link link-hover text-base text-base-content/70 hover:text-primary transition hover:duration-300 font-sans">Contact</a>
                        </div>
                    </div>
                    <div>
                        ...
                        <div class="flex flex-col gap-y-2 mt-6">
                            <a href="#"
                                class="link link-hover text-base text-base-content/70 hover:text-primary transition hover:duration-300 font-sans">Life
                                style</a>
                            <a href="#"
                                class="link link-hover text-base text-base-content/70 hover:text-primary transition hover:duration-300 font-sans">Technology</a>
                            <a href="#"
                                class="link link-hover text-base text-base-content/70 hover:text-primary transition hover:duration-300 font-sans">Travel</a>
                            <a href="#"
                                class="link link-hover text-base text-base-content/70 hover:text-primary transition hover:duration-300 font-sans">Business</a>
                            <a href="#"
                                class="link link-hover text-base text-base-content/70 hover:text-primary transition hover:duration-300 font-sans">Economy</a>
                            <a href="#"
                                class="link link-hover text-base text-base-content/70 hover:text-primary transition hover:duration-300 font-sans">Sports</a>
                        </div>
                    </div>
                </div>
            ...
            <div
                ...
                <div class="flex items-center gap-4 text-base-content/70">
                    ...
                    <a href="../"
                        ...
                        Policy</a>
                    <a href="../"
                        class="text-base hover:text-primary transition hover:duration-300 font-sans">Cookie Policy</a>
                </div>
            </div>
        </div>
    </div>
