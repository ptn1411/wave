...
<div id="notification-list" @click.away="open = false" class="relative flex items-center h-full"
    ...
    <div id="notification-icon relative">
        <button @click="open = !open"
            class="btn btn-ghost btn-circle relative p-1 ml-3 text-gray-400 transition duration-150 ease-in-out rounded-full hover:text-gray-500 focus:outline-none focus:text-gray-500 focus:bg-gray-100">
    ...
    <div x-show="open" x-transition:enter="duration-100 ease-out scale-95"
        ...
        <div class="relative top-0 right-0 w-full my-8 overflow-hidden origin-top max-w-7xl">
            @endif
            <div class="bg-base-200 rounded-md border @if(!isset($show_all_notifications)){{ 'shadow-md' }}@endif"
                ...
                <div class="relative">
                    ...
                    <div id="notification-li-{{ $index + 1 }}"
                        class="flex flex-col pb-5 border-b @if(!isset($show_all_notifications)){{ 'hover:bg-gray-50' }}@endif">
                        ...
                        <span data-id="{{ $notification->id }}" data-listid="{{ $index+1 }}"
                            class="flex justify-start w-full py-1 pl-16 ml-1 text-xs cursor-pointer k hover:text-gray-700 mark-as-read hover:underline">
                ...
                <div id="notification-footer"
                    class="flex items-center justify-center py-3 text-xs font-medium border-t bg-base-200 ">
