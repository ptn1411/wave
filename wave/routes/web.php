...
Route::get('/contact', '\Wave\Http\Controllers\ContactController@index')->name('wave.contact');
Route::post('/contact', '\Wave\Http\Controllers\ContactController@add');
...
Route::get('category/{category}', '\Wave\Http\Controllers\BlogController@category')->name('wave.blog.category');
...
Route::get('{post}', '\Wave\Http\Controllers\BlogController@view');
